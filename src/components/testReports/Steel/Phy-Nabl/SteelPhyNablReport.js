...
import SteelPhyTable from './SteelPhyTable'
...
const styles = StyleSheet.create({
  ...
  const SteelPhyNablReport = ({props, phyNablJobs}) => 
  (            
            <Document>
                <Page style={styles.page} size="A4" wrap>
                    ...
                    <SteelPhyTable phyNablJobs={phyNablJobs} />
                    <ReportDisclaimer />
                    <ReportSignature />     
  ...
  export default SteelPhyNablReport