...
import StdChemTable from './StdChemTable'
...
const styles = StyleSheet.create({
  ...
  const StdChemNonNablReport = ({props, chemNonNablJobs}) => 
  (            
            <Document>
                <Page style={styles.page} size="A4" wrap>
                    ...
                    <StdChemTable chemNonNablJobs={chemNonNablJobs} />
                    <ReportDisclaimer />
                    <ReportSignature />     
  ...
  export default StdChemNonNablReport