...
import SiAnTable from './SiAnTable'

import logo from '../../kdmNabl.jpg'
...
const styles = StyleSheet.create({
  ...
  const SiAnAggrReport = ({props, phyNablSAJobs, phyNablNonSAJobs}) => 
            ...
            <Document>
                <Page style={styles.page} size="A4" wrap>
                    ...
                    {console.log(phyNablNonSAJobs)}
                            ...
                            <AggrPhyTable phyNablNonSAJobs={phyNablNonSAJobs} />
                            <SiAnTable phyNablSAJobs={phyNablSAJobs} phyNablNonSAJobs={phyNablNonSAJobs}/>
                            <ReportDisclaimer />
                            <ReportSignature />     
