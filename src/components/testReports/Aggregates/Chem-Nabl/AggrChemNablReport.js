...
import AggrChemTable from './AggrChemTable'
...
const styles = StyleSheet.create({
  ...
  const AggrChemNablReport = ({props, chemNablJobs}) => 
  (            
            <Document>
                <Page style={styles.page} size="A4" wrap>
                    ...
                    <AggrChemTable chemNablJobs={chemNablJobs} />
                    <ReportDisclaimer />
                    <ReportSignature />     
  ...
  export default AggrChemNablReport